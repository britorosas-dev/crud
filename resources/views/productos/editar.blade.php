            ...
            <div class="col-md-12 order-md-1 mb-5">
                ...
                <div class="row">
                    <div class="col-md-12 order-md-1">
                        ...
                        <form method="post" action="{{ route('producto.update',$producto->id) }}" class="needs-validation" novalidate enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    <label for="nombre">Nombre</label>
                                    <input type="text" class="form-control form-control-lg @error('nombre') is-invalid @enderror" id="nombre" name="nombre" placeholder="" value="{{ (empty(old('nombre')))?$producto->nombre:old('nombre') }}"  maxlength="150" >
                                    @error('nombre')
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('precio') is-invalid @enderror" id="precio" name="precio" placeholder="" value="{{ (empty(old('precio')))?$producto->precio_venta:old('precio') }}"  maxlength="7" >
                                    @error('precio')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control form-control-lg @error('descripcion') is-invalid @enderror" id="descripcion"  name="descripcion" rows="3" maxlength="300">{{ (empty(old('descripcion')))?$producto->descripcion:old('descripcion') }}</textarea>
                                    @error('descripcion')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="custom-select d-block w-100 form-control-lg @error('envio') is-invalid @enderror" id="envio" name="envio" >
                                        ...
                                        @if(empty(old('envio')))
                                            <option value="Gratis" {{ ($producto->envio == 'Gratis')?'selected':'' }}>Gratis</option>
                                            <option value="De Pago" {{ ($producto->envio == 'De Pago')?'selected':'' }}>Pago</option>
                                        @else
                            ...
                            <hr class="mb-4">
                            <button class="btn btn-secondary btn-lg btn-block" type="submit">Editar Producto</button>
                        </form>
                    </div>
                </div>
            </div>
